...
public class registrasi extends javax.swing.JFrame {
    ...
    public void tampilkan_data(){
        ...
        try{
            int no =1;
            String sql = "Select * from akun where id_user like'%"+cari+"%'";
            Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:8111/dsra","root","");
            java.sql.Statement stm = koneksi.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        cblvl.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Level", "Admin", "Pegawai", " " }));
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(22, 22, 22)
                                        .addComponent(cblvl, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(33, 33, 33)
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            String sql ="Delete from akun where id_user='"+idlabel.getText()+"'";
            Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:8111/dsra","root","");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            String sql = "insert akun set id_user='"+idlabel.getText()+"',username='"+user.getText()+"',password='"+pass.getText()+"',nama_user='"+nama.getText()+"',level='"+cblvl.getSelectedItem()+"' On Duplicate Key Update id_user='"+idlabel.getText()+"',username='"+user.getText()+"',password='"+pass.getText()+"',nama_user='"+nama.getText()+"',level='"+cblvl.getSelectedItem()+"'";
            Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:8111/dsra","root","");
            java.sql.PreparedStatement pst = koneksi.prepareStatement(sql);
            pst.execute();
    ...
    private void inputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputActionPerformed
        try{
            String sql = "Insert into akun values ('"+idlabel.getText()+"','"+user.getText()+"','"+pass.getText()+"','"+nama.getText()+"','"+cblvl.getSelectedItem()+"')";
            Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:8111/dsra","root","");
            java.sql.PreparedStatement pst = koneksi.prepareStatement(sql);
            pst.execute();
    ...
    private void dataregisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataregisMouseClicked
        ...
        String id_user = dataregis.getValueAt(baris, 1).toString();
        idlabel.setText(id_user);
        String username = dataregis.getValueAt(baris, 2).toString();
        user.setText(username);
        String password = dataregis.getValueAt(baris, 3).toString();
        pass.setText(password);
        String namauser = dataregis.getValueAt(baris, 4).toString();
        nama.setText(namauser);
        String level = dataregis.getValueAt(baris, 5).toString();
        cblvl.setSelectedItem(level);
